...
func (s *Shader) findUniforms() {
	...
	s.uniformTextureSampler = s.findUniformByName("texture_sampler")
...
func (s *Shader) BindUniformTextureSampler() {
	gl.Uniform1i(s.uniformTextureSampler, 0)
}
